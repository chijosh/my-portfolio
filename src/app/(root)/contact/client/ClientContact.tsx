    ...
    <section>
      <div className="container mx-auto mt-[80px] flex flex-col justify-between gap-10 px-5 pt-5 lg:px-20 xl:flex-row">
        <div className="xl:w-[40%]">
          ...
          Interested in working together or starting a new project? Feel free to reach out via the form. I typically respond within 48 hours.
          </p>
          <Link
